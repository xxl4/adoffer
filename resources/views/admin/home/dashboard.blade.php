                                        ...
                                        <div class="tiles-body">
                                            ...
                                            <div class="m-t-40">
                                                <div class="widget-stats">
                                                    <div class="wrapper"> <span class="item-title">Overall Sales</span> <span class="item-count animate-number semi-bold all_peyout" data-animation-duration="700">{{$data['total_sale']}}</span>
                                                    </div>
                                                </div>
                                                <div class="widget-stats">
                                                    <div class="wrapper"> <span class="item-title">Today’s Sales</span> <span class="item-count animate-number semi-bold day_peyout" data-animation-duration="700">{{$data['today_sale']}}</span>
                                                    </div>
                                                </div>
                                                <div class="widget-stats hidden-sm">
                                                    <div class="wrapper last"> <span class="item-title">Monthly Sales</span> <span class="item-count animate-number semi-bold month_peyout" data-animation-duration="700">{{$data['month_sale']}}</span>
                                                    </div>
                                                </div>
...
{{-- @endphp--}}
                                            ...
                                            <h4><span class="item-count animate-number semi-bold all_peyout_price" data-value="{{$data['total_sale']}}" data-animation-duration="700">{{$data['total_sale']}}</span> USD</h4>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <p class="semi-bold">TODAY</p>
                                            <h4><span class="item-count animate-number semi-bold day_peyout_price" data-value="{{$data['today_sale']}}" data-animation-duration="700">{{$data['today_sale']}}</span> USD</h4>
                                        </div>
                                        <div class="col-md-4 col-sm-3">
                                            <p class="semi-bold">THIS MONTH</p>
                                            <h4><span class="item-count animate-number semi-bold month_peyout_price" data-value="{{$data['month_sale']}}" data-animation-duration="700">{{$data['month_sale']}}</span> USD</h4>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>

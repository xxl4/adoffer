...
<!-- BEGIN PLUGIN CSS -->
<link href=" /vendor/laravel-admin/test2/select2.css" rel="stylesheet" type="text/css" media="screen">
<link href=" /vendor/laravel-admin/test2/pace-theme-flash.css" rel="stylesheet" type="text/css" media="screen">
<link href=" /vendor/laravel-admin/test2/bootstrap.min.css" rel="stylesheet" type="text/css">
<link href=" /vendor/laravel-admin/test2/bootstrap-theme.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/demo.css">
...
<link rel="stylesheet" href=" /vendor/laravel-admin/test2/ionicons.css" type="text/css">
<link href=" /vendor/laravel-admin/test2/messenger.css" rel="stylesheet" type="text/css" media="screen">
<link href=" /vendor/laravel-admin/test2/messenger-theme-flat.css" rel="stylesheet" type="text/css" media="screen">
<link rel="icon" type="image/png" href="https://m4trix.network/Reporting-platform/images/favicon.png">
<link href=" /vendor/laravel-admin/test2/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" media="screen">
<!-- END PLUGIN CSS -->
<!-- BEGIN CORE CSS FRAMEWORK -->
<link href=" /vendor/laravel-admin/test2/icon" rel="stylesheet">
<link href=" /vendor/laravel-admin/test2/webarch.css" rel="stylesheet" type="text/css">
<link href=" /vendor/laravel-admin/test2/custom.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" href=" /vendor/laravel-admin/test2/links_img.css">
...
{{--    };--}}
{{--</script>--}}
{{--<script src=" /vendor/laravel-admin/test2/ckeditor.js " type="text/javascript"></script>--}}

<style>.cke{visibility:hidden;}</style>
{{--<script src=" /vendor/laravel-admin/test2/config.js " type="text/javascript"></script>--}}
<!-- TEXT EDITOR -->

{{--<script>var switch_theme = 0;</script>--}}

<!-- for tutorial.php || headerMenuFaq.php || faq.php -->
<link href=" /vendor/laravel-admin/test2/lity.css" rel="stylesheet">
<script src=" /vendor/laravel-admin/test2/lity.js "></script>
<script src=" /vendor/laravel-admin/test2/jquery.cookie.js "></script>
{{--<script>--}}
...
{{--    window.selectedRole = '';--}}
{{--</script>--}}
{{--<script src=" /vendor/laravel-admin/test2/main.js "></script>--}}
<script type="text/javascript" src=" /vendor/laravel-admin/test2/notifications.js "></script>
<script type="text/javascript" src=" /vendor/laravel-admin/test2/email-broadcast.js "></script>
...
{{--<script type="text/javascript" src=" /vendor/laravel-admin/test2/config(1).js "></script>--}}
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/editor.css">
{{--<script type="text/javascript" src=" /vendor/laravel-admin/test2/zh-cn.js "></script>--}}
{{--<script type="text/javascript" src=" /vendor/laravel-admin/test2/styles.js "></script>--}}
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/scayt.css">
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/dialog.css">
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/tableselection.css">
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/wsc.css">
<link rel="stylesheet" type="text/css" href=" /vendor/laravel-admin/test2/copyformatting.css">
...
<body class="  pace-done"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
    ...
    <script src=" /vendor/laravel-admin/test2/jquery-sparkline.min.js "></script>
    <script src=" /vendor/laravel-admin/test2/jquery.easypiechart.min.js "></script>
    <script src=" /vendor/laravel-admin/test2/jquery.flot.js "></script>
    <script src=" /vendor/laravel-admin/test2/jquery.flot.time.min.js "></script>
    <script src=" /vendor/laravel-admin/test2/jquery.flot.selection.min.js "></script>

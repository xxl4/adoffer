...
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/1927844693922741" async=""></script>--}}
{{--    <script async="" src="http://127.0.0.1:8000/vendor/laravel-admin/test/fbevents.js"></script>--}}
{{--    <script async="" src="http://127.0.0.1:8000/vendor/laravel-admin/test/roundtrip.js.下载"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/pace.min.js" type="text/javascript"></script>--}}
{{--    <!-- BEGIN JS DEPENDECENCIES-->--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery-2.1.4.js"></script>--}}
{{-- <script src="assets/plugins/bootstrapv3/js/bootstrap.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/bootstrap.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/bootstrap-popover-custom-class.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/raphael-min.js.下载"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jqueryblockui.min.js.下载" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery.unveil.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery.scrollbar.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery.animateNumbers.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery.validate.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/select2.js.下载" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/bootstrap-datepicker.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/bootstrap-timepicker.min.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/form_elements.js" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/sweet-alert.min.js.下载"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/clipboard.js"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/messenger.min.js.下载" type="text/javascript"></script>--}}
{{--    <!-- END CORE JS DEPENDECENCIES-->--}}
{{--    <!-- BEGIN CORE TEMPLATE JS -->--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/webarch.js.下载" type="text/javascript"></script>--}}
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/chat.js" type="text/javascript"></script>--}}
...
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/ckeditor.js" type="text/javascript"></script>--}}
...
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/lity.js.下载"></script>--}}

{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/jquery.cookie.js"></script>--}}
    <script>
...
{{--    <script src="http://127.0.0.1:8000/vendor/laravel-admin/test/main.js.下载"></script>--}}
{{--    <script type="text/javascript" src="http://127.0.0.1:8000/vendor/laravel-admin/test/notifications.js.下载"></script>--}}
{{--    <script type="text/javascript" src="http://127.0.0.1:8000/vendor/laravel-admin/test/email-broadcast.js"></script>--}}
...
{{--    <script type="text/javascript" src="http://127.0.0.1:8000/vendor/laravel-admin/test/sendrolling.js.下载"></script>--}}
                               ...
                               <div class="categories_offer_left ">
                                    ...
                                    <div class="col-md-12 accord" data-offer_db="CozyTime Pro">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="active"><a href="https://m4trix.network/Reporting-platform/Reporting-platform.php?id=offer#tab0Offer" role="tab" data-toggle="tab">Summary</a></li>
                                            <li><a href="https://m4trix.network/Reporting-platform/Reporting-platform.php?id=offer#tab0Description" role="tab" data-toggle="tab">Description</a></li>
                                                ...
                                                <div class="row column-seperation">
                                                    <div class="col-md-12">
                                                        <table class="table table-striped table-flip-scroll cf">
                                                            ...
                                                            ></tbody></table></div></div></div><div class="tab-pane" id="tab0Description"><div class="row"><div class="col-md-12"><p></p><p>
                                    ...
                                    <div class="tab-pane" id="tab0ProductsFeed">
                                        ...
                                        <p></p></div></div></div><div class="tab-pane" id="tab0Pixel_Postback"><div class="wait_loader offers-tab-pixels-loader" data-offer-id="277"><img src="http://127.0.0.1:8000/vendor/laravel-admin/test/squares-preloader-gif.svg" alt="preloader"></div><div class="offers-tab-pixels-container" data-offer-id="277"></div></div></div></div>
